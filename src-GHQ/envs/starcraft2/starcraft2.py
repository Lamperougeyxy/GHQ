...
class StarCraft2Env(MultiAgentEnv):
    ...
    def get_agent_action(self, a_id, action):
        ...
        if action == 0:
            ...
            if (self.map_type == "MMM" or self.map_type == "MM") and unit.unit_type == self.medivac_id:
    ...
    def get_state(self):
        ...
        for al_id, al_unit in self.agents.items():
            if al_unit.health > 0:
                ...
                if (self.map_type == "MMM" or self.map_type == "MM") and al_unit.unit_type == self.medivac_id:
        ...
        if ally:  # use new SC2 unit types
            ...
            if self.map_type == "stalkers_and_zealots":
                ...
                if unit.unit_type == 9:
                    ...
                    type_id = 1
            elif self.map_type == "MMM" or self.map_type == "MM":
    ...
    def _init_ally_unit_types(self, min_unit_type):
        ...
        elif self.map_type == "MM":
            self.marine_id = min_unit_type
            self.medivac_id = min_unit_type + 1
        elif self.map_type == "MMT":
            self.marauder_id = min_unit_type
            self.marine_id = min_unit_type + 1
