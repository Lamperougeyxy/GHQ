...
from .epsilon_schedules import DecayThenFlatScheduleForRODE
...
class EpsilonGreedyActionSelector:
    ...
    def select_action(self, agent_outputs, avail_actions: th.Tensor, t_env, test_mode=False):
        # Assuming agent_outputs is a batch of Q-Values for each agent bav
        self.epsilon = self.schedule.eval(t_env)
        if test_mode:
...
class SoftEpsilonGreedyActionSelector:
    def __init__(self, args):
        self.args = args
        self.schedule = DecayThenFlatScheduleForRODE(args.epsilon_start, args.epsilon_finish, args.epsilon_anneal_time,
